#ifndef RADIATION_RADIATION_FERMI_HPP_
#define RADIATION_RADIATION_FERMI_HPP_
...
KOKKOS_INLINE_FUNCTION Real fermi2(Real eta) {
  return (eta > ETA0) ? (eta * eta * eta) * fermi2p(eta) : Kokkos::exp(eta) * fermi2m(eta);
}
...
KOKKOS_INLINE_FUNCTION Real fermi3(Real eta) {
  return (eta > ETA0) ? (eta * eta * eta * eta) * fermi3p(eta)
                      : Kokkos::exp(eta) * fermi3m(eta);
}
...
#endif  // RADIATION_RADIATION_FERMI_HPP_
